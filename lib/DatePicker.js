...
class DatePicker extends Component<void, Props, State> {
     ...
     */
    render() {
        const { min, max, theme, dateConfig, confirmText, cancelText, headerFormat, showHeader, showFooter, customHeader, showCaption, header, footer } = this.props;
        const value = this.state.value;
        ...
        const footerWithHandler = React.Children.map(this.props.children, child => {
          return React.cloneElement(child, {
            confirmHandler: this.handleFinishBtnClick,
